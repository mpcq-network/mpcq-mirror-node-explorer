...
export class CoreConfig {
    ...
    private static parse(obj: Record<string, unknown>): CoreConfig {
        return new CoreConfig(
            fetchString(obj, "productName") ?? "MPCQ Network",
            ...
            fetchString(obj, "documentTitlePrefix") ?? "MPQC",
            fetchString(obj, "productDescription") ?? "MPCQ Explorer is a ledger explorer for the MPCQ network.",
            fetchString(obj, "metaDescription"),
            fetchURL(obj, "metaURL"),
            fetchURL(obj, "builtOnLogoLightURL") ?? localPathToURL("mpcq_logo_no_bg.png"),
            fetchURL(obj, "builtOnLogoDarkURL") ?? localPathToURL("mpcq_logo_no_bg.png") ,
